...
namespace Titan.Tools.FontBuilder
{
    ...
    {
        public void DrawText(string text, Graphics graphics, in SpriteSheetArguments args, bool drawDebugSquares = false)
        {
            ...
            foreach (var character in text.Replace(Environment.NewLine, string.Empty))
            {
                ...
                graphics.DrawString(character.ToString(), font, brush, x + args.Padding.Left, y + args.Padding.Top, StringFormat.GenericTypographic);
